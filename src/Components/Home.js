  ...
  return (
    <div className='w-full h-screen pt-[100px]  bg-[#0a0a16]'>
        <div className=' mx-auto pl-8 pr-2 md:pl-[150px] h-full  flex flex-col justify-center '>
            ...
            <p><button className='flex justify-between group items-center w-[130px] px-3 py-2 bg-blue-500 hover:bg-[bisque] text-black text-2xl font-semibold rounded-xl'> <Link to='/Projects'> Work</Link> <HiArrowNarrowRight size={20} className=' group-hover:rotate-90 duration-300'/> </button>
            </p>
