...
const Home = () => {
  return (
    <div className='w-full pt-[100px]  bg-[#0a0a16]'>
        <div className=' mx-auto pl-8 md:pl-[150px] h-full  flex flex-col justify-end  '>
            ...
            <h2 className='text-4xl sm:text-7xl  text-blue-400'>I'm a Front End Web Developer.</h2>
            ...
            <p><button className='flex justify-between group items-center w-[130px] px-3 py-3 bg-blue-500 hover:bg-[bisque] text-black text-2xl font-semibold rounded-xl'>Work <HiArrowNarrowRight size={20} className=' group-hover:rotate-90 duration-300'/> </button>
            </p>
